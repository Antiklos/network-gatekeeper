...
receive (interface_id) propose (address) (price)
...
interface_id: This is a string of max length 256 that identifies the link level interface the message came in from
